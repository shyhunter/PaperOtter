...
export const nl: Dictionary = {
  ...
  'saveStep.saveAs': 'Opslaan als…',
  'saveStep.saveChangesTo': 'Wijzigingen opslaan in {name}',
  'saveStep.saveReplacesOriginal': 'Opslaan vervangt het originele bestand. Gebruik ‘Opslaan als…’ om het te behouden en een kopie te schrijven.',
  ...
  'protectPdf.alreadyProtected': 'Deze pdf is al met een wachtwoord beveiligd. Ontgrendel hem eerst en beveilig hem daarna opnieuw.',
  ...
  'pdfProcessor.jpxAlreadyEncoded': 'Deze pdf bevat {images}, al JPEG2000-gecodeerd: Papercut kan ze niet verder comprimeren.',
