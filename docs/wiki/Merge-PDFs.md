...
- **Encrypted source files.** PaperOtter can read pages from an encrypted PDF for merging purposes, but this doesn't remove or bypass any protection on the *original* file: the merged output is a new, unencrypted document made up of the pages themselves.
