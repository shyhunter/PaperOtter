#!/usr/bin/env node
/**
 * Generates LICENSES/NOTICES.txt: the copyright notices Papercut owes for the
...
function rustCrates() {
  // No --filter-platform. The graph is resolved per target, and Papercut ships
 ...
 * copy. Papercut's entire macOS .dmg is 9 MB, so that version would have more
...
const header = `Papercut third-party notices
${RULE}

Generated by scripts/generate-notices.mjs. Do not edit by hand: run the script.
${FINGERPRINT_LINE}${fingerprints()}

Papercut's own source is MIT, in LICENSE. This file covers the third-party code
...
The Rust list is the union across every target Papercut ships (macOS arm64 and
